...
Selecciona el archivo de prueba test.cy.js desde la interfaz de Cypress y ejecuta la prueba.

O bien, puedes ejecutar la prueba en modo headless con el siguiente comando:
npx cypress run --spec cypress/e2e/1-getting-started/test.cy.js
